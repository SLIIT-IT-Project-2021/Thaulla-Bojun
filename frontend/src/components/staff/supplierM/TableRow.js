...
export default class StudentTableRow extends Component {
    ...
    deleteStudent() {
        axios.delete('http://localhost:8070/suppliers/delete/' + this.props.obj._id)
            .then((res) => {
    ...
    render() {
        return (
            <tr>
                ...
                <td>{this.props.obj.priorExperiance}</td>
                <td>{this.props.obj.itemsPurchased}</td>
                <td><img src ={"images/" + this.props.obj.photo} style={{width:"100px" , height:"100px"}} 
                className = "border border-danger rounded-circle"
                /></td>
                <td style={{width:"250px"}}>
                    <Link className="edit-link" to={`/edit-supplierM/${this.props.obj._id}/${this.props.obj.supplierID}/${this.props.obj.fullName}/${this.props.obj.address}/${this.props.obj.priorExperiance}/${this.props.obj.itemsPurchased}`}>
