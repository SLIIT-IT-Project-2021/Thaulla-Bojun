        ...
        return (
            <tr>
                ...
                <td style={{width:"250px"}}>
                    <Link className="edit-link" to={`/edit-deliveryM/${this.props.obj._id}/${this.props.obj.name}/${this.props.obj.age}/${this.props.obj.gender}/${this.props.obj.birthdate}/${this.props.obj.photo}`}>
