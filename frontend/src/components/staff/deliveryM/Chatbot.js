...
const DeliveryChatbot = ()=>{
    ...
    const sendEmailHandler = async (e)=>{
        ...
        try {
            const {data} = await axios.post("http://localhost:8070/api/auth/sendDeliveryEmail" , {email , description} , config);
    ...
    return(
        <div>
            ...
            <button className="open-button " onClick={openForm}><i className="fa fa-android" aria-hidden="true"></i>Assign Here</button>
...
export default DeliveryChatbot;